        ...
        if (context is Application) {
            context.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
                ...
                override fun onActivityStarted(activity: Activity) {
                    ...
                    if (foregroundActivities == 1 && !isChangingConfiguration) {
                        ...
                        if (Constants.CALL_FRAMEWORK_NATIVE == Constants.framework &&
                            TUILogin.isUserLogined() && !CallActivityRouter.isCallActivity(activity)) {
                ...
                override fun onActivityResumed(activity: Activity) {
                    CallBusinessBridge.onActivityResumed(activity)
                }

                override fun onActivityPaused(activity: Activity) {
                    CallBusinessBridge.onActivityPaused(activity)
                }
