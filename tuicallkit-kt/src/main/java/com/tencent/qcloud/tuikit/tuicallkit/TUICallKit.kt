...
abstract class TUICallKit {
    ...
    /**
     * Set custom call activity class name.
     */
    open fun setCallActivityClassName(className: String?) {}

    /**
     * Intercept incoming calls before opening the call page.
     */
    open fun setIncomingCallInterceptor(interceptor: IncomingCallInterceptor?) {}
